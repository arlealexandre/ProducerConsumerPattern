...
public interface IProdConsBufferExec {

    /**
     * Put the message m in the buffer
     **/
    public void put(MessageExec m) throws InterruptedException;
     ...
     **/
    public void put(MessageExec m, int n) throws InterruptedException;
     ...
     **/
    public MessageExec get() throws InterruptedException;
